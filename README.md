...
2. In the repository settings on GitHub, go to **Pages** and select the `main` branch (or `gh-pages`) and the root folder. Save.

3. Your site will be available at `https://<your-username>.github.io/<repo>/` in a few minutes.

Optional: Add a `CNAME` file with your custom domain or use GitHub Pages settings to configure it.

If you want, I can also initialize the repository, update contact details, or add a `CNAME` file—tell me which changes you want.
# SoftTech-Software-Solutions2
